...
def clean_text(text):
    ...
    This replaces unsupported characters (like emojis) with '?' to prevent crashes.
    """
    if not text: return ""
...
def generate_pdf_report(username, role, score, feedback, resume_skills, missing_skills, category):
    class PDF(FPDF):
        ...
        def footer(self):
            ...
            self.cell(0, 10, 'Generated by NexHire | Developed by Karunya K. P. | linkedin.com/in/karunyakp', 0, 0, 'C')
    ...
    # Use clean_text() on ALL dynamic inputs
    ...
    # Clean up Markdown (*, #) and sanitize emojis
    raw_feedback = feedback.replace("*", "").replace("#", "")
    pdf.multi_cell(0, 7, txt=clean_text(raw_feedback))
    pdf.ln(10)
    ...
    pdf.multi_cell(0, 5, "Note: This report was generated by AI. Please verify details manually.")
    
    # Safe return for Streamlit
